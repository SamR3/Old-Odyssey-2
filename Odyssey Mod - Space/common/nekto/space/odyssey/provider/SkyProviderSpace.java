...
public class SkyProviderSpace extends IRenderHandler
{
    ...
    public SkyProviderSpace(String planet, boolean renderMoon, boolean renderSun)
    {
        ...
        // if (this.minecraft.thePlayer.ridingEntity != null)
        {
            ...
            if (var20 > 0.0F)
            {
                if (this.planetToRender != null)
                {
                    ...
                    var23.addVertexWithUV(var10, 0, var10, 0.4F, 1.0F);
                    var23.addVertexWithUV(var10, 0, -var10, 0.4F, 0.0F);
